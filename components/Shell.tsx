...
import { BookOpenCheck, FolderKanban, Users2, Landmark, Layers, User } from 'lucide-react'
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <aside className="fixed inset-y-0 left-0 z-40 w-[244px] border-r border-slate-200 bg-white flex flex-col">
        ...
        <div className="border-t border-slate-200 p-3">
          <Link href={withView('/settings', sp)} className="flex items-center gap-3 px-2 py-2 rounded-xl hover:bg-slate-100">
            <div className="h-8 w-8 rounded-full bg-slate-200 grid place-items-center"><User className="w-4 h-4 text-slate-600" /></div>
